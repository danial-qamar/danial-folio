...
return [
    ...
    /** Web Services */
    'mobile_country_code' => env('MOBILE_COUNTRY_CODE', '92'),
    ...
    'github_username'               => env('GITHUB_USERNAME', 'danial-qamar'),
    'github_show_only_repositories' => env('GITHUB_SHOW_ONLY_REPOSITORIES', 'danialfolio'),
