...
class SettingFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            'application' => [
                'name' => 'DanialFolio v'.env('APP_VERSION'),
            ],
            'config' => [
                'empty_section' => true,
            ],
            'blog' => [
                'logo'                    => null,
                'name'                    => 'DanialFolio<br/><span class="dg">Notes</span>',
                'button'                  => 'View All',
                'is_active'               => true,
                'button_url'              => '/blog',
            ...
            'meta' => [
                ...
                'meta_description' => 'DanialFolio is a free and open-source web application for creating and managing your own portfolio website.',
                'meta_keywords'    => 'danialfolio, danialfolio cms, open source cms, quick portfolio website',
            ],
            //
            'design' => [
                'animation'                   => false,
