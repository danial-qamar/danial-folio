@if ($is_active)
<x-core.layout :$is_filled :$with_padding module_name="about" :$button_header :$button_url :$is_centered :$title :$subtitle
    ...
    <div class="my-12 flex flex-wrap" id="about-section-wrapper">
        ...
        <div class="w-full p-4 text-center lg:w-1/4 lg:p-8" id="profile">
            <x-themes.common.profile :centered="true" :show_info="true" />
        </div>
        {{-- About Section --}}
