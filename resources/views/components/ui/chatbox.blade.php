...
<div>
    ...
    <!-- WhatsApp Config -->
    <div data-whatsapp-url="{{ config('danialfolio.whatsapp_web_url', env('WHATSAPP_WEB_URL')) }}"
        data-country-code="{{ config('danialfolio.mobile_country_code', env('MOBILE_COUNTRY_CODE')) }}"
