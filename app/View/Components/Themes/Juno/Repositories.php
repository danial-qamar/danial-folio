...
class Repositories extends Component
{
    ...
    public function __construct()
    {
        try {
            ...
            $this->repoQuantity = $settings['repository_quantity'] ?? 9;
            $this->is_app_active = $settings['github_is_active'] ?? true;
            $this->show_graphs = $settings['show_graphs'] ?? true;
            $this->show_repositories_feed = $settings['show_repositories_feed'] ?? true;
        } catch (Throwable $e) {
