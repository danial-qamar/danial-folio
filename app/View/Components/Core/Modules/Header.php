...
class Header extends Component
{
    ...
    public function __construct(
        ...
        // Meta Tags
        $metaTitle = $setting?->meta['meta_title'] ?? null;
        if (empty($metaTitle) || $metaTitle === 'Danial Qamar | Portfolio' || $metaTitle === 'Danial Qamar | Portfolio.' || $metaTitle === 'Default Title') {
            $metaTitle = 'Danial Qamar | Full Stack Laravel Developer';
        }
        ...
        // Favicon
        $rawFavicon = $setting?->design['favicon'] ?? null;
        $this->favicon = $rawFavicon ? \Illuminate\Support\Str::after($rawFavicon, 'public/') : null;
